/* linux/arch/arm/mach-rkpx2/clock_data.c
 *
...
static const struct apll_clk_set apll_clks0[] = {
...
static const struct apll_clk_set apll_clks1[] = {
	//rate, nr ,nf ,no,core_div,peri,axi,hclk,pclk,_ahb2apb
	//_APLL_SET_CLKS(1800, 1, 75, 1, 8, 41,  41,  81,21),
	//_APLL_SET_CLKS(1752, 1, 73, 1, 8, 41,  41,  81,21),
	//_APLL_SET_CLKS(1704, 1, 71, 1, 8, 41,  41,  81,21),
	...
	_APLL_SET_CLKS(1608, 1, 67, 1, 8, 41, 21, 41, 21),
	_APLL_SET_CLKS(1560, 1, 65, 1, 8, 41, 21, 41, 21),
	_APLL_SET_CLKS(1512, 1, 63, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1464, 1, 61, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1416, 1, 59, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1368, 1, 57, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1320, 1, 55, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1296, 1, 54, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1272, 1, 53, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1200, 1, 50, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1176, 1, 49, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1128, 1, 47, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1104, 1, 46, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(1008, 1, 42, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(888,  1, 37, 1, 8, 21, 21, 41, 21),
	_APLL_SET_CLKS(816 , 1, 34, 1, 8, 11, 21, 41, 21),
	_APLL_SET_CLKS(792 , 1, 33, 1, 8, 11, 21, 41, 21),
	_APLL_SET_CLKS(696 , 1, 29, 1, 8, 11, 21, 41, 21),
	_APLL_SET_CLKS(600 , 1, 25, 1, 4, 11, 11, 21, 21),
	_APLL_SET_CLKS(504 , 1, 21, 1, 4, 11, 11, 21, 21),
	_APLL_SET_CLKS(408 , 1, 17, 1, 4, 11, 11, 21, 21),
	_APLL_SET_CLKS(312 , 1, 13, 1, 2, 11, 11, 21, 11),
	_APLL_SET_CLKS(252 , 1, 21, 2, 2, 11, 11, 21, 11),
	_APLL_SET_CLKS(216 , 1, 18, 2, 2, 11, 11, 21, 11),
	_APLL_SET_CLKS(126 , 1, 21, 4, 2, 11, 11, 11, 11),
	_APLL_SET_CLKS(48  , 1, 16, 8, 2, 11, 11, 11, 11),
	_APLL_SET_CLKS(0   , 1, 21, 4, 2, 21, 21, 41, 21),
...
static struct _pll_data apll_data0 =SET_PLL_DATA(APLL_ID,(void *)apll_clks0);
static struct _pll_data apll_data1 =SET_PLL_DATA(APLL_ID,(void *)apll_clks1);
...
static void periph_clk_set_init(void)
{
	...
	unsigned int value = *(volatile unsigned int * )(RK30_GRF_BASE+0x1c8);
	int flag = value & (1<< (value&0xF));           
	*(volatile unsigned int * )(RK30_GRF_BASE+0x1c8) = flag;
